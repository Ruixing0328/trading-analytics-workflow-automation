#!/usr/bin/env python3
"""Push the bundled example trade into the configured Notion Trade Journal."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Show the request body without creating a page.")
...
def main() -> None:
    ...
    sample_payload_path = PROJECT_ROOT / "examples" / "sample_trade.json"
    trade_entry = load_trade_entry_from_json(sample_payload_path)
